...
import { Upload, Camera, User, Loader } from 'lucide-react';
      ...
      <Card className="glass-dark border-white/10 overflow-hidden shadow-lg">
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h3 className="text-lg font-medium mb-3 text-blue-200">Upload Your Photo</h3>
              <p className="text-white/70 mb-6">
                See how outfits look on you with our virtual try-on technology
              </p>
              ...
              <div className="flex flex-col gap-3 w-full">
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    variant="outline"
                    className="w-full border-blue-400/30 text-white hover:bg-white/10"
                  >
            ...
            >
              <h3 className="text-lg font-medium mb-3 text-purple-200">Or Use Olivia Bloom</h3>
              <p className="text-white/70 mb-6">
