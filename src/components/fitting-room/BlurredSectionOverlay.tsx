...
const BlurredSectionOverlay: React.FC<BlurredSectionOverlayProps> = ({ onClickChooseModel }) => {
  return (
    <motion.div 
    ...
    >
      ...
      <h3 className="text-xl font-medium text-white mb-2">Choose a photo or Olivia to preview these outfits</h3>
      ...
      <Button
        ...
        className="mt-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500"
      >
        <User className="mr-2 h-5 w-5" /> Choose Your Model
      </Button>
    </motion.div>
  );
};
