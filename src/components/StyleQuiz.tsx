...
const quizQuestions = [
  {
    id: 'colors',
    question: 'What are your favorite colors for clothing?',
    options: [
  ...
  {
    id: 'occasions',
    question: 'What kind of outfits do you need?',
    options: [
  ...
  {
    id: 'climate',
    question: 'What climate conditions do you prefer for your clothing?',
    options: [
      ...
      { value: 'flexible', label: 'I am flexible', icon: CloudSun },
    ],
    multiSelect: true,
  },
];
...
const StyleQuiz = ({ onComplete, onClose, standalone = false }: StyleQuizProps) => {
  const { user } = useAuth();
  ...
  return (
    <div className="min-h-full w-full max-w-3xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-slate-900/90 to-purple-900/60 backdrop-blur-lg border border-white/10 rounded-xl shadow-xl p-6 md:p-8">
        {/* Quiz Header */}
            ...
            >
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 flex gap-4 mt-6">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">
                    Hi there! Based on your preferences, I'll start recommending outfits and helping you organize your wardrobe. Ready to get started?
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white sm:ml-auto"
                >
