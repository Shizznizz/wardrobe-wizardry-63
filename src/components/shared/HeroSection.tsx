              ...
              >
                {buttons.map((button, index) => (
                  <Button
                    ...
                    className={cn(
                      button.variant === 'secondary' ? "bg-black text-white" : "bg-gradient-to-r from-[#ff4ecb] to-[#a97eff]",
                      "text-white hover:scale-[1.03] transition-transform font-bold py-2 px-6 rounded-xl shadow-md",
                      button.className
                    )}
                    size="lg"
                  >
