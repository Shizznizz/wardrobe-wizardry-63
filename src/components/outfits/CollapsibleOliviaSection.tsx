...
import OliviaStyleChatDialog from './OliviaStyleChatDialog';
...
const CollapsibleOliviaSection = ({ onChatClick, selectedDate }: CollapsibleOliviaSectionProps) => {
