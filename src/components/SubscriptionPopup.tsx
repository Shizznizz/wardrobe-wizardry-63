      ...
      <DialogContent className="sm:max-w-md bg-gradient-to-b from-slate-900 to-purple-950 border-purple-500/20 text-white">
        <DialogHeader className="relative">
          ...
          <DialogDescription className="text-center text-white/80">
            Take your styling experience to the next level with advanced features and unlimited options!
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 gap-4 py-4">
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-white">Multiple Photos</h3>
              <p className="text-sm text-white/70">Upload and try on outfits for multiple occasions and events.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-white/70">Access to premium outfit collections curated by expert stylists.</p>
            </div>
          </motion.div>
